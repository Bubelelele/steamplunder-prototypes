...
public class EffectManager : MonoBehaviour {
    ...
    [SerializeField] private GameObject gearToWeaponPrefab;
    ...
    public void GearToWeaponPickup(Vector3 position)
    {
        GameObject cog = Instantiate(gearToWeaponPrefab, position, Quaternion.identity);
        Rigidbody rb = cog.GetComponent<Rigidbody>();
        rb.AddForce(Random.Range(-3f, 3f), 4f, Random.Range(-3f, 3f), ForceMode.Impulse);
    }
